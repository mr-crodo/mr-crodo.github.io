...
window.addEventListener('DOMContentLoaded', () => {
  ...
  setClock('.timer', deadLine); //todo: Modal
  ...
  window.addEventListener('scroll', showModalByScroll); //Ispolzuem Classi dla kartocek
  ...
  // div.render();
  // !mojno kak verxneye  a mojno i tak
  ...
  new MenuCard("img/tabs/post.jpg", "post", 'Меню "Постное"', 'Меню “Постное” - это тщательный подбор ингредиентов: полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.', 21, '.menu .container', 'menu__item', 'big').render(); //Form

  const forms = document.querySelectorAll('form');
  const message = {
    loading: 'Zaqruzka',
    success: 'Spasibo skoro svajemsa',
    failure: 'Ctoto powlo ne tak...'
  };
  forms.forEach(item => {
    postData(item);
  });
