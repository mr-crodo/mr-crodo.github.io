...
audio.src = `/assets/audio/audio${randomAudio}.mp3`;
...
function startGame() {
  ...
  gameArea.innerHTML = '';
  for (let i = 0; i < getQualityElements(HEIGHT_ELEM); i++) {
  ...
  for (let i = 0; i < getQualityElements(HEIGHT_ELEM * setting.traffic); i++) {
    ...
    enemy.style.background = `transparent url(/assets/img/enemy${randomEnemy}.png) center / cover no-repeat`;
